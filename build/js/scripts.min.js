...
!function(e,t){"use strict";var n=e.navigator.userAgent.toLowerCase();if(/trident/gi.test(n)||/msie/gi.test(n)){for(var o,r=t.querySelectorAll("use"),i=0;i<r.length;i++)o="#"+(o=r[i].getAttribute("xlink:href")).split("#")[1],r[i].setAttribute("xlink:href",o);if(!t.createElementNS||!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var a,l,s="localStorage"in e&&null!==e.localStorage,c=function(){t.body.insertAdjacentHTML("afterbegin",l)},g=function(){t.body?c():t.addEventListener("DOMContentLoaded",c)};if(s&&6==localStorage.getItem("inlineSVGrev")&&(l=localStorage.getItem("inlineSVGdata")))return g();try{(a=new XMLHttpRequest).open("GET","img/svg/symbol/sprite.svg",!0),a.onload=function(){200<=a.status&&a.status<400&&(l=a.responseText,g(),s&&(localStorage.setItem("inlineSVGdata",l),localStorage.setItem("inlineSVGrev",6)))},a.send()}catch(e){}}}(window,document),window.onload=function(){};
$(document).ready(function(){var i=window.navigator.userAgent.toLowerCase();if(/trident/gi.test(i)||/msie/gi.test(i)){$(".slider__text").css("margin-bottom","120px");var n=!1,t=$(".main-header__icon");t.parent().on("mousedown",function(){$(this).children().css({fill:"rgba(255, 255, 255, 0.5)"}),n=!0}),t.parent().on("mouseout",function(){$(this).children().css({fill:"rgba(255, 255, 255, 0.3)"}),n&&($(this).children().css({fill:"rgba(255, 255, 255, 1)"}),n=!1)}),t.parent().on("mousemove",function(){n||$(this).children().css({fill:"rgba(255, 255, 255, 1)"})})}});
$(document).ready(function(){document.createElement("picture"),$(".slider").slick({dots:!0,arrows:!0,infinite:!0,speed:300,slidesToShow:1});var e=$(".servicies__item");e.on("click",function(){e.removeClass("servicies__item--active"),$(this).addClass("servicies__item--active")});var o=new Popup({popup:".modal__popup",closeModal:".modal__popup-close",overlay:".modal__overlay"});$(".contacts__map-link").on("click",function(e){e.preventDefault(),o.open($(".modal__map"))}),$(".contacts__link").on("click",function(e){e.preventDefault(),o.open($(".modal__write"))})});